...
#        PROJECT: T-Remix            #
#        Author: RK HACKER          #
#  email: rkvsk73@gamil.com   #
######################################
echo -e "\e[32m[*]\e[34m WELCOME TO DEVRK TOOLS  \e[m "
echo
...
echo "
        ...
        WELCOME TO DEV RK  TOOLS_-^^TECH KNOW LINUX^^-_ SUBSCRIBE YOUTUBE CHANNEL
...
echo -e "\033[1;33m[*]system ok -- CHECKED BY DEV RK\e[m "
...
tput cup 6 30
echo -e "\x1b[42m DEV RK channel \x1b[m"
tput cup 9 0
